...
<form id="Form1" name="Form1"
      action="${pageContext.request.contextPath}/admin/orders/findOrders.do"
      method="post">
    <table cellSpacing="1" cellPadding="0" width="100%" align="center"
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td class="ta_01" bgColor="#ffffff"><input type="text"
                                                                   name="id" size="15" value="${id}" id="Form1_userName"
                                                                   class="bg"/>
                        </td>
                        <td height="22" align="center" bgColor="#f5fafe" class="ta_01">
                            收件人：
        ...
        <tr>
                    ...
                    <c:forEach items="${orders}" var="order">
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td align="center" style="HEIGHT: 22px"><c:if
                                ...
                                <a
                                        href="${pageContext.request.contextPath}/admin/orders/delOrderById.do?id=${order.id}&type=admin">
                                    <img
            ...
            <syl:pager pageIndex="${pageModel.pageIndex}" pageSize="${pageModel.pageSize}"
                       recordCount="${pageModel.recordCount}"
                       submitUrl="${pageContext.request.contextPath}/admin/orders/findOrders.do?pageIndex={0}&id=${id}&receiverName=${receiverName}"/>
        </tr>
        </TBODY>
    </table>
</form>
