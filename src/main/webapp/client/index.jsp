...
<head>
    ...
    <link rel="icon icon" href="${pageContext.request.contextPath}/client/images/favorite.icon"/>
    <%-- 导入css --%>
    ...
    <table width="900px" border="0" cellspacing="0">
        <tr>
            ...
            <table cellspacing="0" class="ctl">
                <tr>
                    <td width="485" height="29">${notice.title }<br>${notice.n_time }<br>${notice.details }</td>
                </tr>
            </table>
            </td>
                    ...
                    <tr>
                        <c:forEach items="${products }" var="product">
                            <td style="width:80px; text-align:center">
                                <a href="${pageContext.request.contextPath}/product/findProductById.do?id=${product.id}">
                                    <img src="${pageContext.request.contextPath }${product.imgurl}" width="102" height="130"
                                         border="0"/>
                                </a>
                                <br/>
                                <a href="${pageContext.request.contextPath}/product/findProductById.do?id=${product.id}">${product.name}</a>
                                    <%-- <br />作者:${pArray[2] } --%>
                            </td>
                        </c:forEach>
                    </tr>
