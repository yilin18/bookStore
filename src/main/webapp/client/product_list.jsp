...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath }/client/css/pager.css" type="text/css" />
</head>
		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						...
						${category==null?"全部商品目录":category}&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;图书列表
					</div>
...
<%--										</c:if>--%>
					...
					<syl:pager pageIndex="${pageModel.pageIndex}"
							   ...
							   submitUrl="${pageContext.request.contextPath}/product/findProduct.do?pageIndex={0}&category=${category}"/>
				</td>
			</tr>
		</table>
	</div>
