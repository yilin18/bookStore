...
<head>
    ...
    <link href="${pageContext.request.contextPath}/client/css/pager.css" rel="stylesheet" type="text/css"/>
</head>
                ...
                <table cellspacing="0" class="infocontent">
                    <tr>
                        <td style="padding:20px"><p><b>我的订单</b></p>
                            <p>
                                共有<font style="color:#FF0000">${pageModel.recordCount}</font>订单
                            </p>
                                ...
                                <c:forEach items="${orders}" var="order">
                                    <tr>
                                        ...
                                        <td class="tableopentd03">
                                            ...
                                            <c:if test="${order.paystate==0 }">
                                                <a href="${pageContext.request.contextPath}/order/delOrderById.do?id=${order.id}&type=client">刪除</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
