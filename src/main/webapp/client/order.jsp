...
<head>
    ...
    <script>
        function createOrder() {
            ...
            var address = document.getElementById("receiverAddress").value;
            console.log(name);
            console.log(phone);
            console.log(address);
                                ...
                                <table width="100%" border="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                收货地址：<input name="receiverAddress" id="receiverAddress" type="text"

                                                            style="width:350px"/>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <br/> 收货人：&nbsp;&nbsp;&nbsp;&nbsp;<input
                                                    name="receiverName" id="receiverName" type="text"
                                                    value="${login_user.username}"
                                                    style="width:150px"/>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <br/> 联系方式：<input type="text" id="receiverPhone" name="receiverPhone"
                                                                  value="${login_user.telephone}" style="width:150px"/>&nbsp;&nbsp;&nbsp;&nbsp;

                                            </p>
                                            <hr/>
                                            <p style="text-align:right">
                                                <img src="images/gif53_029.gif" width="204" height="51"
                                                     border="0"  <c:if test="${totalPrice==0}">style="display: none" </c:if> onclick="createOrder();"/>
                                            </p>
                                        </td>
                                    </tr>
                                </table>
