...
<head>
    ...
    <script>
        function changeProductNum(count, totalCount, id) {
            ...
            location.href = "${pageContext.request.contextPath}/cart/changeCart.do?id="
                + id + "&count=" + count;
        }
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <c:forEach items="${cart}" var="entry" varStatus="vs">
                                            <table width="100%" border="0" cellspacing="0"
                                                   <c:if test="${entry.value<1}">style="display: none" </c:if> >
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                        <a href="${pageContext.request.contextPath}/cart/changeCart.do?id=${entry.key.id}&count=0"
                                        ...
                                        <div style="text-align:right; margin-top:10px">
                                            <a href="${pageContext.request.contextPath}/product/findProduct.do">
                                            ...
                                            <a href="${pageContext.request.contextPath}/client/order.jsp"
                                               <c:if test="${total==0}">style="display: none" </c:if>>
